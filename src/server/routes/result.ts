...
import { createResult, deleteResult, getResults, updateResult } from '../services/result'
...
resultRouter.put('/:id', adminHandler, async (req: RequestWithUser, res: any) => {
  const { id } = req.params
...
resultRouter.post('/:surveyId', adminHandler, async (req: RequestWithUser, res: any) => {
  const { surveyId } = req.params
...
resultRouter.delete('/:id', adminHandler, async (req: RequestWithUser, res: any) => {
  const { id } = req.params
